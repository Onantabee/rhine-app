...
const TeamMembers = () => {
    ...
    return (
        <div className="flex flex-col md:gap-3 h-full">
            <div className="p-4 md:p-6 pb-0 md:pb-0">
                <div className="flex items-center justify-between border-0 md:border-b border-gray-200 dark:border-[#404040] pb-3 flex-shrink-0">
                    <div className="flex justify-between gap-2">
                        <h1 className="text-2xl md:text-3xl text-gray-600 dark:text-[#bfbfbf] truncate">Team Members</h1>
                        <span className="text-gray-500 dark:text-[#bfbfbf] text-md md:text-2xl p-2 rounded-full bg-gray-100 dark:bg-[#404040] w-8 h-8 md:w-10 md:h-10 flex items-center justify-center">
