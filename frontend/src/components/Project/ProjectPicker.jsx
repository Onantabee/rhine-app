    ...
    return (
        <>
            <div className="relative" ref={ref}>
                ...
                {open && (
                    <div className="absolute top-full left-0 mt-2 w-64 bg-white border border-gray-200 dark:border-[#404040] rounded-[5px ] shadow-lg z-50 overflow-hidden">
                        {projects.length > 0 ? (
                                ...
                                {projects.map((project) => (
                                    <button
                                        ...
                                        className={`w-full flex items-center gap-3 h-14 px-2 text-sm transition-colors cursor-pointer ${activeProject?.id === project.id
                                            ...
                                            : "text-gray-700 dark:text-[#cccccc] hover:bg-gray-50"
                                            }`}
                                    >
